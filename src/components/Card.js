...
export default function Card ({bookmark,onAction }) {

  return (
    <div className="h-100 card" data-id={bookmark.id} id={bookmark.id} draggable={true}>

      <a href={bookmark.url} target="_self" className="d-flex-col txt-center">
        <img
          alt={bookmark.title}
